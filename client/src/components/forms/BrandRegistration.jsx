                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-5 items-stretch">
                                    ...
                                    <div className="space-y-4 flex flex-col justify-between">
                                          ...
                                          <div className="space-y-1.5">
                                                <label htmlFor="brandName" className="block text-xs font-bold text-[var(--color-primary-black)] font-[var(--font-primary)] tracking-wide">
                                                      Brand Name
                                                </label>
                                          ...
                                          {/* 2. Brand Slug Input */}
                                          <div className="space-y-1.5">
                                                <label htmlFor="brandSlug" className="block text-xs font-bold text-[var(--color-primary-black)] font-[var(--font-primary)] tracking-wide">
                                                      URL Slug
                                                </label>
                                                <div className="relative">
                                                      <span className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                                                ...
                                                <p className="text-[10px] text-[var(--color-beige-dark)] font-[var(--font-secondary)] mt-0.5">
                                                      aura.com/brands/<span className="text-[var(--color-secondary-black)] font-semibold">maison-verte</span>
                                                </p>
                                          </div>

                                          {/* 3. Origin Country Dropdown */}
                                          <div className="space-y-1.5">
                                                <label htmlFor="country" className="block text-xs font-bold text-[var(--color-primary-black)] font-[var(--font-primary)] tracking-wide">
                                                      Country of Origin
                                                </label>
                                                <div className="relative">
                                                      <span className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                                          ...
                                          >
                                                <div className="flex flex-col items-center justify-center">
                                                      ...
                                                      <p className="mb-0.5 text-xs text-[var(--color-secondary-black)] font-[var(--font-secondary)]">
                                                            <span className="font-semibold text-[var(--color-primary-black)]">Click to upload</span> or drag
                                                      </p>
                                                      <p className="text-[10px] text-[var(--color-beige-dark)] font-[var(--font-secondary)]">
                                                            SVG, PNG, or JPG (MAX. 2MB)
                                                      </p>
                                                </div>
                                                <input id="logoFile" type="file" className="hidden" accept="image/*" />
                                          </label>
                                    </div>
