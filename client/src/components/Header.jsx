...
const Header = () => {
    ...
    const activeClass =
        "text-beige-dark font-bold relative after:absolute after:bottom-[-4px] after:left-0 after:w-full after:h-[2px] after:bg-beige-dark";
    const defaultClass =
        "text-secondary-black hover:text-beige-accent transition-colors duration-200";
            ...
            <nav className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between gap-4">
                ...
                <div className="hidden min-[901px]:flex items-center gap-8 font-medium text-[14px] tracking-wide font-['Alegreya_Sans',sans-serif]">
                    ...
                    <NavLink
                        ...
                        className={`${isMale ? activeClass : defaultClass}`}
                    >
                        Male
                    </NavLink>
                    <NavLink
                        to="/perfumes?gender=female"
                        className={`${isFemale ? activeClass : defaultClass}`}
                    >
                        Female
                    </NavLink>
                    <NavLink
                        to="/perfumes?gender=unisex"
                        className={`${isUnisex ? activeClass : defaultClass}`}
                    >
                        Unisex
                    </NavLink>
                    <NavLink
                        to="/perfumes"
                        className={`${location.pathname === "/perfumes" && !location.search ? activeClass : defaultClass}`}
                    >
                        Explore
                    </NavLink>
                </div>
                ...
                <div className="flex items-center gap-1 sm:gap-4 text-secondary-black justify-end">
                    ...
                    <form
                        ...
                        className="hidden min-[901px]:block relative max-w-52.5 w-full"
                    >
                        <input
                        ...
                        <button
                            type="submit"
                            className="absolute left-3 top-1/2 -translate-y-1/2 p-0.5 cursor-pointer text-beige-dark hover:text-primary-black transition-colors"
                        >
                    ...
                    <div className="flex items-center gap-1 sm:gap-2 shrink-0">
                        ...
                        <Link
                            ...
                            aria-label="Shopping Bag Container"
                            className="hover:text-beige-accent p-2 transition-colors relative group"
                        >
                ...
                <div className="min-[901px]:hidden border-t border-beige-light/50 bg-white font-['Alegreya_Sans',sans-serif]">
                    <div className="px-6 py-4 flex flex-col gap-4 font-medium text-sm tracking-wide">
                        <NavLink
                            ...
                            className={({ isActive }) =>
                                `${isActive ? "text-beige-dark font-bold pl-2 border-l-2 border-beige-dark" : "text-secondary-black"} py-1`
                            }
                        >
                            Home
                        </NavLink>
                        <NavLink
                            ...
                            onClick={() => setIsMobileMenuOpen(false)}
                            className={() =>
                                `${isMale ? "text-beige-dark font-bold pl-2 border-l-2 border-beige-dark" : "text-secondary-black"} py-1`
                            }
                        >
                            Male Catalog
                        </NavLink>
                        <NavLink
                            ...
                            onClick={() => setIsMobileMenuOpen(false)}
                            className={() =>
                                `${isFemale ? "text-beige-dark font-bold pl-2 border-l-2 border-beige-dark" : "text-secondary-black"} py-1`
                            }
                        >
                            Female Catalog
                        </NavLink>
                        <NavLink
                            ...
                            onClick={() => setIsMobileMenuOpen(false)}
                            className={() =>
                                `${isUnisex ? "text-beige-dark font-bold pl-2 border-l-2 border-beige-dark" : "text-secondary-black"} py-1`
                            }
                        >
                            Unisex Collection
                        </NavLink>
                        <NavLink
                            ...
                            onClick={() => setIsMobileMenuOpen(false)}
                            className={() =>
                                `${location.pathname === "/perfumes" && !location.search ? "text-beige-dark font-bold pl-2 border-l-2 border-beige-dark" : "text-secondary-black"} py-1`
                            }
                        >
                            Explore All
                        </NavLink>
