...
const Cart = () => {
    ...
    const { cart, appliedCoupon, totalItems, totalQuantity, currentCartState } = useSelector(
                                        ...
                                        <div className="flex-1 flex flex-col sm:flex-row justify-between items-center w-full h-full overflow-hidden gap-3 sm:gap-0 ">
                                            <Link to={`/perfume/${item?.perfume?._id}`}>
                                                <div className="flex flex-col justify-center text-center md:text-left overflow-hidden cursor-pointer">
                                                    <span className="text-[11px] font-bold font-primary text-beige-dark tracking-widest uppercase block leading-none">
                                                        {item?.perfume?.brand}
                                                    </span>
                                                    <h3 className="text-sm font-bold text-primary-black mt-0.5 truncate max-w-xs flex items-center gap-0.5 capitalize font-primary">
                                                        {item?.perfume?.name}
                                                        <span className="">
                                                            {item?.perfume?.concentration}
                                                        </span>
                                                    </h3>
                                                    <p className="text-[13px]  font-primary text-secondary-black">
                                                        Size:{" "}
                                            ...
                                            <div className="flex items-center justify-between sm:justify-end gap-6 w-full sm:w-auto shrink-0">
                                                ...
                                                <div className="text-right min-w-20">
                                                    <span className="text-[12px] font-primary text-secondary-black block leading-none mb-0.5">
                                                        Total
                                                    </span>
                                                ...
                                                <button
                                                    onClick={() =>
                                                        removeFromCartHandler(item?.perfume._id)
                                                    }
                    ...
                    <div className="lg:col-span-1 h-full flex flex-col justify-between">
                        <div className="bg-primary-white rounded-2xl border border-secondary-white p-5 space-y-5 flex flex-col justify-between h-full shadow-xs">
                            <div className="space-y-4">
                                <h2 className="text-lg font-bold border-b border-secondary-white pb-2 text-primary-black">
                                    Order Summary
                                </h2>

                                {/* Promo Code Entry Frame */}
                                <div className="space-y-1.5">
                                    <label className="text-xs font-secondary text-secondary-black flex gap-2">
                                ...
                                <div className="space-y-2 pt-2 font-secondary text-xs text-secondary-black">
                                    <div className="flex justify-between">
                                        ...
                                        <span className="font-bold text-primary-black">
                                            Rs {currentCartState?.subtotal}
                                        </span>
                                    </div>
                                    <div className="flex justify-between">
                                        <span>Estimated Shipping Charges</span>
                                        <span className="font-bold text-primary-black">
                                            {currentCartState?.shipping === 0
                                                ? "FREE"
                                                : `Rs ${currentCartState?.shipping}`}
                                        </span>
                                    </div>
                                    <div className="flex justify-between">
                                        <span>GST 18% </span>
                                    ...
                                    <div className="flex justify-between">
                                        <span>
                                            Discounted Amount{" "}
                                            {`( ${currentCartState.discountPercentage}% )`}{" "}
                                        </span>
