...
const FilterSidebar = ({ searchParams, setSearchParams, setIsMobileFilterOpen }) => {
            ...
            const getMetadata = async () => {
                  try {
                        ...
                        if (targetData) {
                              ...
                              const urlMax = Number(searchParams.get("maxPrice")) || priceBounds?.max || 25000
      ...
      if (loading) {
            return <div className="text-sm font-medium text-center py-8 text-secondary-black font-secondary animate-pulse">Loading Filters...</div>
      }
                        ...
                        <div className="space-y-4 font-secondary">
                              <div className="relative h-8">
                                    ...
                                    <div
                                          ...
                                          style={{
                                                left: `${((priceRange.min - absoluteBounds.min) /
                                                      (absoluteBounds.max - absoluteBounds.min)) * 100}%`,
