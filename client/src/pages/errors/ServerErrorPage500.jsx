...
const ServerErrorPage500 = () => {
    return (
        <section className="min-h-screen flex flex-col justify-center items-center px-6 text-center">
            <h1 className="text-8xl md:text-9xl font-bold text-green-dark">500</h1>
            ...
            <p className="mt-4 max-w-lg text-secondary-black text-lg leading-relaxed">
                Our perfumers are working behind the scenes. Something unexpected occurred, but
                we're already restoring the experience.
            </p>
            ...
            <Link to="/" className="mt-4 text-beige-dark font-medium hover:text-beige-accent">
                Back to Home
            </Link>
        </section>
    );
