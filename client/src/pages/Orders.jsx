    ...
    return (
        <div className="min-h-screen flex flex-col bg-secondary-white text-primary-black font-primary">
            ...
            <div className="max-w-5xl w-full mx-auto px-4 sm:px-6 pt-6 text-xs tracking-wide font-secondary text-beige-dark">
                <Link to="/" className="hover:text-primary-black cursor-pointer">
                    Home
                </Link>
            ...
            <main className="grow max-w-5xl w-full mx-auto px-4 sm:px-6 py-10">
                <div className="border-b pb-5 mb-8">
                    <h1 className="text-2xl sm:text-3xl font-bold tracking-tight text-primary-black">
                        Order History
                    </h1>
                    <p className="text-xs sm:text-sm text-zinc-500 font-secondary mt-1">
                        Track and manage your premium fragrance acquisitions.
                    </p>
                </div>
                ...
                {isLoading ? (
                    <div className="py-20 flex flex-col items-center justify-center gap-3">
                        ...
                        <p className="text-xs font-secondary text-zinc-500 tracking-wider uppercase">
                            Loading your ledger...
                        </p>
                    </div>
                ) : orders.length === 0 ? (
                    <div className="py-24 text-center border-2 border-dashed border-gray-200 rounded-3xl bg-white max-w-md mx-auto px-6">
                        ...
                        <p className="text-xs font-secondary text-zinc-500 mt-1 mb-6">
                            You haven't initiated any secure checkout operations yet.
                        </p>
                        <Link
                            to="/"
                            className="inline-block px-5 py-3 bg-zinc-900 text-white rounded-xl text-xs font-secondary font-bold tracking-widest uppercase hover:bg-zinc-800 transition-colors shadow-sm"
                        >
                            Explore Collections
                        </Link>
                    </div>
                                    ...
                                    <div className="bg-zinc-50/70 border-b border-gray-100 px-5 py-4 flex flex-wrap items-center justify-between gap-4 text-xs font-secondary">
                                        <div className="flex flex-wrap items-center gap-x-6 gap-y-2">
                                            ...
                                            <div>
                                                ...
                                                <span className="font-mono font-medium text-zinc-600 uppercase">
                                                    {order?._id}
                                                </span>
                                            </div>
                                            <div>
                                                ...
                                                <span className="font-semibold text-secondary-black uppercase">
                                                    {order?.paymentMethod || "N/A"}
                                                </span>
                                            </div>
                                        </div>
                                        <div className="flex items-center gap-2 font-primary text-sm font-bold text-primary-black sm:ml-auto">
                                            <span className="text-xs font-secondary font-normal text-zinc-400 mr-1">
                                                Total:
                                            </span>
                                    ...
                                    <div className="p-5 flex flex-col md:flex-row md:items-center justify-between gap-6">
                                        ...
                                        <div className="flex items-center gap-5 min-w-0 flex-1">
                                            ...
                                            <div className="min-w-0 space-y-1">
                                                ...
                                                <p className="text-xs text-zinc-500 font-secondary">
                                                    Quantity: {order?.totalQnt}{" "}
                                                    {order?.totalQnt === 1 ? "item" : "items"}
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex items-center justify-between md:justify-end gap-6 border-t md:border-t-0 pt-4 md:pt-0 shrink-0">
                                            ...
                                            <div className="flex flex-row md:flex-col gap-2">
                                                <div
                                                    className={`px-3 py-1 rounded-full text-[11px] font-semibold tracking-wide border capitalize flex items-center gap-1.5 ${getStatusStyle(order?.orderStatus)}`}
                                                >
                                                    <span className="w-1 h-1 rounded-full bg-current"></span>
                                                    Status: {order?.orderStatus}
                                                </div>
                                                <div
                                                    className={`px-3 py-1 rounded-full text-[11px] font-semibold tracking-wide border capitalize flex items-center gap-1.5 ${getStatusStyle(order?.paymentStatus)}`}
                                                >
