...
const PerfumeShowcase = () => {
    ...
    const currentSortLabel =
        sortOptions.find((opt) => opt.value === currentSortValue)?.label || "Featured";
    ...
    const renderPageButtons = () => {
        ...
        if (currentPage > 3) {
            pages.push(
                <span key="left-ellipsis" className="px-1.5 text-beige-dark font-secondary">
                    ...
                </span>
            );
        }
        ...
        if (currentPage < totalPages - 2) {
            pages.push(
                <span key="right-ellipsis" className="px-1.5 text-beige-dark font-secondary">
                    ...
                </span>
            );
        }
    ...
    const renderButton = (pageNumber) => {
        return (
            <button
                ...
                className={`w-9 h-9 border rounded-xl font-semibold transition-all duration-200 cursor-pointer flex items-center justify-center text-xs ${
            ...
            <main className="grow max-w-7xl w-full mx-auto px-6 py-12 flex gap-8 items-start relative">
                ...
                <aside className="hidden md:block w-64 shrink-0 sticky top-24">
                    <div className="flex items-center gap-2 text-primary-black font-bold text-lg mb-4 px-2">
                        ...
                        <span className="font-artistic-secondary text-sm uppercase tracking-wider">
                            Filters
                        </span>
                    </div>
                    <FilterSidebar
                ...
                <div className="flex-1 w-full">
                    ...
                    <div className="flex justify-between items-center mb-6 font-secondary relative">
                        <span className="text-beige-dark text-xs tracking-wide">
                            Showing {pagination.totalItems > 0 ? startItem : 0} - {endItem} of{" "}
                            {pagination?.totalItems} formulations
                        </span>
                    ...
                    {perfumes.length > 0 ? (
                        ...
                        <div className="text-center py-20 bg-primary-white rounded-2xl border border-beige-light border-dashed px-4">
                            <p className="font-primary text-xl text-primary-black font-medium">
                                No botanical profiles match your curation.
                            </p>
                            <button
