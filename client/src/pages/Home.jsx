...
import { FaArrowRight, FaLeaf, FaTint, FaWind, FaAward, FaShieldAlt } from "react-icons/fa";
            ...
            <header className="relative px-6 py-16 md:py-20 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center bg-secondary-white font-primary">
                <div className="lg:col-span-7 space-y-6 z-10 text-center lg:text-left">
                    ...
                    <p className="font-secondary text-sm sm:text-base text-secondary-black max-w-xl mx-auto lg:mx-0 leading-relaxed font-light">
                        Access a curated ledger of the world’s most sought-after luxury and niche
                        perfumes. No duplicates, no compromises; sourced directly from authentic
                        designer maisons.
                    </p>
                    ...
                    <div className="w-full max-w-md bg-white border border-zinc-200 rounded-3xl p-6 sm:p-8 relative shadow-sm hover:shadow-md transition-all duration-300 group overflow-hidden">
                        ...
                        <div className="bg-zinc-50 border border-zinc-100 p-4 sm:p-5 rounded-2xl relative z-10">
                            ...
                            <p className="text-xs text-secondary-black font-secondary leading-relaxed font-light">
                                Every purchase arrives in its complete native retail presentation
                                box, housing uncompromised serials and clean batch codes matching
                        ...
                        <div className="relative z-10 w-full md:w-1/2 p-8 md:p-14 space-y-6 bg-linear-to-r from-secondary-white via-secondary-white/95 to-transparent md:to-secondary-white/0">
                            ...
                            <div className="space-y-3">
                                ...
                                <p className="font-secondary text-sm md:text-base text-secondary-black max-w-md leading-relaxed font-light">
                                    Filter our entire architectural catalog database by world-class
                                    fragrance legacy houses, modern niche collectives, and master
                                    artisanal curators.
                                </p>
                            </div>
            ...
            <section className="bg-primary-white border-y border-beige-light py-8 px-6">
                <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
                    <div className="flex flex-col md:flex-row items-center md:items-start gap-4">
                        <div className="p-3 rounded-xl bg-secondary-white text-green-dark">
                            <FaLeaf size={20} />
                        </div>
                        <div>
                            <h4 className="font-bold text-base text-primary-black">
                                100% Authenticity Sourced
                            </h4>
                            <p className="font-secondary text-xs text-secondary-black mt-1">
                                Directly curated from verified luxury networks. No clones, no
                                compromises.
                            </p>
                        </div>
                    </div>
                    <div className="flex flex-col md:flex-row items-center md:items-start gap-4">
                        ...
                        <div>
                            ...
                            <p className="font-secondary text-xs text-secondary-black mt-1">
                                Handpicked architectural masterworks from elite global designers.
                            </p>
                        </div>
                    </div>
                    <div className="flex flex-col md:flex-row items-center md:items-start gap-4">
                        <div className="p-3 rounded-xl bg-secondary-white text-beige-dark">
                            <FaWind size={20} />
                        </div>
                        <div>
                            <h4 className="font-bold text-base text-primary-black">
                            ...
                            <p className="font-secondary text-xs text-secondary-black mt-1">
                                Skip the blind buys. Explore organized breakdowns before deciding.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="max-w-7xl mx-auto space-y-8">
                    <div className="text-center max-w-md mx-auto space-y-2">
                        ...
                        <p className="font-secondary text-sm text-secondary-black">
                            Explore the newest additions to our collection, where innovation meets
                            timeless elegance.
                        </p>
                    </div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        {newArrivals &&
                            newArrivals.map((prod) => <Card key={prod._id} perfume={prod} />)}
                    </div>
                </div>
            </section>
                ...
                <div className="max-w-7xl mx-auto space-y-10">
                    ...
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                        ...
                        <p className="font-secondary text-xs sm:text-sm text-secondary-black max-w-md font-light leading-relaxed">
                            We’ve categorized our luxury global catalog into distinct sensory
                            profiles, making it effortless to find the exact olfactory signature for
                            your style.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
                        ...
                        <div className="bg-primary-white border border-beige-light/50 p-4 sm:p-8 rounded-2xl sm:rounded-3xl flex flex-col justify-between group hover:shadow-md transition-all duration-300">
                            <div className="space-y-3 sm:space-y-4">
                                ...
                                <p className="font-secondary text-[11px] sm:text-xs text-secondary-black leading-relaxed font-light line-clamp-4 sm:line-clamp-none">
                                    Unapologetic fragrances built for distinction. Dominated by raw
                                    Tuscan leather, smoky agarwood, dark amber, and sophisticated
                                    animalic accords.
                                </p>
                            </div>
                            <div className="pt-4 sm:pt-8 flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-t border-beige-light/20 mt-4 sm:mt-6">
                                <span className="text-[10px] sm:text-[11px] text-beige-dark font-medium font-secondary">
                                    Ideal for: Presence
                                </span>
                                <Link
                                    to="/perfumes?category=leather,tobacco,warm,oud"
                                    className="text-[11px] sm:text-xs font-bold text-green-dark flex items-center gap-1 group-hover:translate-x-1 transition-transform"
                                >
                        ...
                        <div className="bg-primary-white border border-beige-light/50 p-4 sm:p-8 rounded-2xl sm:rounded-3xl flex flex-col justify-between group hover:shadow-md transition-all duration-300">
                            <div className="space-y-3 sm:space-y-4">
                                ...
                                <p className="font-secondary text-[11px] sm:text-xs text-secondary-black leading-relaxed font-light line-clamp-4 sm:line-clamp-none">
                                    An elegant whisper rather than a shout. Features classic
                                    Florentine iris, soft white musk, delicate violet leaf, and
                                    clean, velvety suede notes.
                                </p>
                            </div>
                            <div className="pt-4 sm:pt-8 flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-t border-beige-light/20 mt-4 sm:mt-6">
                                <span className="text-[10px] sm:text-[11px] text-beige-dark font-medium font-secondary">
                                    Ideal for: Quiet Luxury
                                </span>
                                <Link
                                    to="/perfumes?category=powdery,musk,vetiver"
                                    className="text-[11px] sm:text-xs font-bold text-green-dark flex items-center gap-1 group-hover:translate-x-1 transition-transform"
                                >
                                    View <FaArrowRight className="text-[8px] sm:text-[9px]" />
                                </Link>
                        ...
                        <div className="bg-primary-white border border-beige-light/50 p-4 sm:p-8 rounded-2xl sm:rounded-3xl flex flex-col justify-between group hover:shadow-md transition-all duration-300">
                            <div className="space-y-3 sm:space-y-4">
                                ...
                                <p className="font-secondary text-[11px] sm:text-xs text-secondary-black leading-relaxed font-light line-clamp-4 sm:line-clamp-none">
                                    Effortless, clean daytime classics. Vibrant profiles showcasing
                                    effervescent Amalfi citrus, clean marine accord, and freshly
                                    crushed mint leaves.
                                </p>
                            </div>
                            <div className="pt-4 sm:pt-8 flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-t border-beige-light/20 mt-4 sm:mt-6">
                                <span className="text-[10px] sm:text-[11px] text-beige-dark font-medium font-secondary">
                                    Ideal for: Clean Signature
                                </span>
                                <Link
                                    to="/perfumes?category=fresh,green,floral,aquatic"
                                    className="text-[11px] sm:text-xs font-bold text-green-dark flex items-center gap-1 group-hover:translate-x-1 transition-transform"
                                >
                                    View <FaArrowRight className="text-[8px] sm:text-[9px]" />
                                </Link>
                        ...
                        <div className="bg-primary-white border border-beige-light/50 p-4 sm:p-8 rounded-2xl sm:rounded-3xl flex flex-col justify-between group hover:shadow-md transition-all duration-300">
                            <div className="space-y-3 sm:space-y-4">
                                ...
                                <p className="font-secondary text-[11px] sm:text-xs text-secondary-black leading-relaxed font-light line-clamp-4 sm:line-clamp-none">
                                    Rich, addictive scent profiles loaded with warmth. Masterfully
                                    blends Madagascar vanilla bean, dark chocolate, and roasted
                                    tonka bean.
                                </p>
                            </div>
                            <div className="pt-4 sm:pt-8 flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-t border-beige-light/20 mt-4 sm:mt-6">
                                ...
                                <Link
                                    to="/perfumes?category=gourmand,vanilla"
                                    className="text-[11px] sm:text-xs font-bold text-green-dark flex items-center gap-1 group-hover:translate-x-1 transition-transform"
                                >
                                    View <FaArrowRight className="text-[8px] sm:text-[9px]" />
                                </Link>
            ...
            <section className="max-w-7xl mx-auto px-6 py-10 space-y-6" id="shop">
                <div className="flex justify-between items-end">
                    <div>
                        ...
                        <p className="font-artistic-secondary text-xs text-secondary-black mt-1">
                            Whether bold and charismatic or soft and captivating, find the fragrance
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 ">
                    <div
                        ...
                        className="rounded-2xl overflow-hidden hover:shadow-md transition-shadow group cursor-pointer flex flex-col justify-between h-85"
                    >
                        <img
                            src={menFragsImage}
                            alt="mens fragrance image"
