...
import { FaInfoCircle, FaBalanceScale, FaFlask, FaShieldAlt, FaCode, FaGlobe } from 'react-icons/fa';
                  ...
                  <main className="grow max-w-4xl w-full mx-auto px-6 py-16 space-y-16">
                        ...
                        <div className="bg-amber-50/40 border-2 border-amber-200/70 p-6 md:p-8 rounded-2xl shadow-sm flex flex-col md:flex-row gap-5 items-start">
                              ...
                              <div className="space-y-3 font-secondary text-base text-secondary-black leading-relaxed">
                                    ...
                                    <p>
                                          This entire platform is an independent design concept, interactive portfolio project, and a non-commercial hobby built by me.
                                          <strong> No real money is accepted</strong>, and no physical packages will ever be mailed out.
                                          You are warmly invited to freely explore the storefront, look up fragrance ingredients, and simulate placing sample orders.
                                    </p>
                              </div>
                        </div>
                        ...
                        <div className="space-y-12 font-secondary text-base md:text-lg text-secondary-black leading-relaxed">
                              ...
                              <section className="bg-primary-white border border-beige-light rounded-2xl p-6 md:p-8 space-y-4 shadow-sm">
                                    ...
                                    <p>
                                          This website is strictly a safe, simulated testing environment. By using this application, you agree and understand that all traditional shopping functions. such as adding items to your shopping bag, typing test checkout information, and viewing simulated balances are visual demonstrations. No commercial transactions are binding, no real money changes hands, and no items are packed or shipped.
                                    </p>
                              </section>
                              ...
                              <section className="bg-primary-white border border-beige-light rounded-2xl p-6 md:p-8 space-y-4 shadow-sm">
                                    ...
                                    <p>
                                          Even though the shop checkout process is fake, the data behind the fragrances is completely real. All perfume charts, notes breakdowns, longevity descriptions, and historical details listed in our catalog are <span className="text-green-dark font-bold">100% genuine and accurate</span> to the real-world fragrance industry. I compiled this detailed information carefully to provide a rich, authentic educational experience.
                                    </p>
                              </section>
                              ...
                              <section className="bg-primary-white border border-beige-light rounded-2xl p-6 md:p-8 space-y-4 shadow-sm">
                                    ...
                                    <p>
                                          To ensure the complete realism of the olfactive profiles shown throughout this application, structural data, fragrance accord breakdowns, pyramids, and descriptions were compiled using references from trusted online perfume resources. Specifically, key educational reference material was sourced from{' '}
                                          <a
                                          ...
                                          as well as other major community fragrance encyclopedias. All credit for collective catalog organization guidelines belongs to their respective platforms.
                                    </p>
                              </section>
                              ...
                              <section className="bg-primary-white border border-beige-light rounded-2xl p-6 md:p-8 space-y-4 shadow-sm">
                                    ...
                                    <p>
                                          When typing data into the checkout testing pages, please use fake or placeholder details. <span className="text-amber-800 font-bold">Do not input real credit cards, active passwords, or private home addresses.</span> As the **Admin (Krut)**, I have set up this database exclusively for safe software demonstration purposes. Neither the application nor the admin will ever ask you for authentic, sensitive financial credentials.
                                    </p>
                              </section>
                              ...
                              <section className="bg-primary-white border border-beige-light rounded-2xl p-6 md:p-8 space-y-4 shadow-sm">
                                    ...
                                    <p>
                                          This platform was created solely as a live display of modern full-stack web development techniques and user interface design. Brand names, high-quality logos, and product trademarks referenced throughout the system belong entirely to their respective legal owners. They are included here under creative fair-use for contextual, aesthetic display purposes within a personal student portfolio.
                                    </p>
                              </section>
                        ...
                        <div className="pt-10 border-t border-beige-light text-center space-y-3">
                              ...
                              <p className="text-base font-secondary text-secondary-black/80 max-w-xl mx-auto">
                                    By interacting with this demo, you acknowledge that you are testing a safe, sandboxed web development portfolio project.
                              </p>
                        </div>
