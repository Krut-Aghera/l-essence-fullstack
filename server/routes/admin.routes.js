...
adminRouter.get("/perfumes/:perfumeID", verifyToken, authorizeRole("admin"), fetchCurrentPerfume);

adminRouter.get("/users", verifyToken, authorizeRole("admin"), getAllUsers);
...
adminRouter.delete("/perfumes/:perfumeID", verifyToken, authorizeRole("admin"), removePerfume);

adminRouter.get("/dashboard", verifyToken, authorizeRole("admin"), fetchAdminDashboard);
