...
const updatedPerfumeDetailsValidation = () => {
      return [
            ...
            body("notes[top]").optional().trim().isString().withMessage("Top notes must be a string"),
            ...
            body("notes[base]").optional().trim().isString().withMessage("Base notes must be a string"),
            ...
            body("deletedPublicIds")
                  ...
                  .custom((value) => {
                        try {
                              ...
                              throw new Error("deletedPublicIds must be valid JSON");
                        }
                  }),
      ];
};
